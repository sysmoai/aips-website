...
const BRAND_META: Record<string, {
  ...
  "chatgpt-plus-bangladesh": {
    ...
    filterBySlug: true,
    faqs: [
      { q: "What does ChatGPT Plus include?", a: "ChatGPT Plus includes GPT-5.4 Thinking model access, DALL-E image generation, deep research mode, AI agent mode (for autonomous tasks), Projects (persistent chat workspaces), custom GPTs, and file/code analysis. Features and usage limits can vary as OpenAI updates ChatGPT over time." },
      { q: "What is the difference between Starter Shared and Premium Shared?", a: "Starter Shared has up to 7 users per account — lowest price but occasional slowdowns during peak hours. Premium Shared has only 2–3 users — more stable, faster responses, ৳950/month. For full privacy and dedicated access, choose Personal at ৳2,990." },
      { q: "Can I use ChatGPT Plus for coding?", a: "Yes. ChatGPT Plus includes GPT-5.4 Thinking which excels at code generation, debugging, code review, and explaining complex codebases in Python, JavaScript, TypeScript, and 50+ languages. For autonomous coding agents, consider ChatGPT Business which includes Codex." },
      { q: "Is ChatGPT Plus better than the free version?", a: "ChatGPT Plus is significantly more powerful: access to GPT-5.4 Thinking (vs GPT-4o mini on free), image generation, deep research, agents, Projects, and much higher usage limits. For any serious work, Plus is essential." },
  ...
  "chatgpt-business-bangladesh": {
    ...
    seoDescription: "ChatGPT Business Bangladesh from BDT 699/mo. Privacy-by-default, Codex, unlimited GPT-5.3, admin controls. bKash/Nagad. 5-30 min delivery. AI Premium Shop.",
    description: "ChatGPT Business ($25/mo annual or $30/mo monthly) is built for professional teams. Key difference from Plus: privacy-by-default — business conversations are not used to train OpenAI models. Also includes admin controls, Codex (autonomous coding agent), unlimited GPT-5.3 usage, and team workspaces. Available in Starter Shared (৳699), Premium Shared (৳1,299), and Personal (৳3,990) tiers. Pay via bKash.",
    accentColor: "#10a37f",
    filterBySlug: true,
    faqs: [
      { q: "How is ChatGPT Business different from ChatGPT Plus?", a: "The key differences: (1) Privacy-by-default — business conversations are not used to train OpenAI models by default. (2) Admin controls to manage team seats. (3) Codex for autonomous software development. (4) Unlimited GPT-5.3 usage. Best for companies, agencies, and professionals handling client data." },
      { q: "Does ChatGPT Business protect my company data?", a: "Yes. ChatGPT Business uses privacy-by-default — your conversations are not used to train OpenAI models. This is the primary reason businesses upgrade from Plus. It's important for client confidentiality, legal work, and sensitive business decisions." },
      { q: "What is Codex and is it included in ChatGPT Business?", a: "Codex is OpenAI's autonomous AI software development agent (launched April 2026). It can write, test, and fix code autonomously in the cloud — not just autocomplete. Codex is included in ChatGPT Business and is used by engineering teams to automate entire development tasks without constant supervision." },
      { q: "Is ChatGPT Business suitable for agencies in Bangladesh?", a: "Yes. ChatGPT Business is widely used by marketing agencies, development agencies, and content studios in Bangladesh. The privacy-by-default guarantee is especially important when working with client data." },
  ...
  "chatgpt-pro-bangladesh": {
    ...
    seoDescription: "ChatGPT Pro Bangladesh from BDT 4,500/mo. Unlimited GPT-5.4 Pro, Sora video, Codex, deep research. bKash/Nagad. Power users. AI Premium Shop.",
    description: "ChatGPT Pro ($200/month) is the highest tier of ChatGPT — unlimited GPT-5.4 Pro mode (the most intelligent version), Sora video generation, unlimited deep research, Codex for autonomous coding, and maximum AI performance. Available as Premium Shared (৳4,500) or Personal (৳29,900). Features can vary as OpenAI updates ChatGPT Pro over time.",
    accentColor: "#10a37f",
    filterBySlug: true,
    faqs: [
      { q: "What makes ChatGPT Pro different from Plus?", a: "ChatGPT Pro includes: (1) Unlimited GPT-5.4 Pro mode — the most intelligent version OpenAI offers. (2) Sora video generation from text. (3) Unlimited deep research (limited in Plus). (4) Codex for autonomous software development. (5) Maximum usage limits across all features. Built for researchers, power users, and businesses. Features can vary as OpenAI updates ChatGPT." },
      { q: "What is Sora and is it included in ChatGPT Pro?", a: "Sora is OpenAI's AI video generation model. It creates realistic videos from text descriptions — scenes, animations, product demos. ChatGPT Pro includes Sora access. Generate and iterate on video content directly inside ChatGPT." },
      { q: "Does ChatGPT Pro include Codex?", a: "Yes. ChatGPT Pro includes Codex — OpenAI's autonomous AI coding agent (launched April 2026). Unlike regular code suggestions, Codex can write, test, and fix entire codebases autonomously. Especially powerful for developers building products and agencies automating development workflows." },
      { q: "Who needs ChatGPT Pro?", a: "ChatGPT Pro is ideal for: academic researchers doing deep analysis, authors and screenwriters, data scientists, AI product builders, software development agencies, and any business that needs maximum AI output every day." },
  ...
  "chatgpt-go-bangladesh": {
    ...
    seoDescription: "ChatGPT Go Bangladesh BDT 1,196/mo. Personal account, GPT-5.3, image gen, agents — between Free and Plus. bKash/Nagad. 2-4hr delivery. AI Premium Shop.",
    description: "ChatGPT Go ($8/month) sits between ChatGPT Free and ChatGPT Plus — your own personal account with GPT-5.3 access, image generation, deep research, and agent mode. May show occasional ads. AIPS price: ৳1,196/month. Ideal if you want a dedicated personal account without paying the full Plus price.",
    accentColor: "#10a37f",
    filterBySlug: true,
    faqs: [
      { q: "What is ChatGPT Go?", a: "ChatGPT Go is OpenAI's $8/month plan — positioned between Free and Plus. It's a personal account with GPT-5.3, image generation, deep research, and agents. Slightly fewer features than Plus ($20/month) and may show occasional ads. Great for moderate users who want their own ChatGPT account." },
      { q: "Is ChatGPT Go personal or shared?", a: "ChatGPT Go is always a personal account — your own login, full privacy, all features. No sharing with other users. This is the main advantage over shared Plus plans." },
      { q: "How does ChatGPT Go compare to ChatGPT Plus?", a: "Go sits between Free and Plus. Plus ($20/month) gives GPT-5.4 Thinking, higher usage limits, and is ad-free. Go ($8/month) gives GPT-5.3, similar core features, but lower limits and may show ads. If you want a dedicated account at lower cost, Go is the right choice." },
      { q: "Is ChatGPT Go good value at ৳1,196?", a: "Yes. At ৳1,196/month you get your own personal ChatGPT account with GPT-5.3 — much cheaper than Plus Personal at ৳2,990. Ideal for users who want personal privacy and dedicated access without the full Plus price." },
