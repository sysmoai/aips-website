...
const faqs = [
  ...
  { question: "Which AI tool should I buy from Rajshahi?", answer: "Start with ChatGPT Plus (BDT 499/mo) — it covers writing, coding, research, and image generation. For Rajshahi freelancers, add Midjourney (BDT 1,199/mo) for design work. Students should get ChatGPT Plus + Grammarly (BDT 470/mo)." },
];
