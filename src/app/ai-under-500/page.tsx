...
const faqs = [
  ...
  { question: "Can I get premium AI tools under BDT 500 in Bangladesh?", answer: "Yes! 20 AI tools are available under BDT 500/mo at AI Premium Shop — including ChatGPT Plus (BDT 350), Google AI Pro (BDT 500), Canva Pro (BDT 499), and more. All with bKash/Nagad payment." },
];
    ...
    <main className="min-h-screen"><section className="mx-auto max-w-4xl px-5 sm:px-8 py-12">
      ...
      <div className="mt-6 p-4 rounded-xl border border-white/[0.04] bg-white/[0.02]">
        ...
        <p className="text-[0.875rem] leading-relaxed text-[#8a91a8]">
          <strong>BDT 500/মাসের নিচে 20টি প্রিমিয়াম AI টুল</strong> পাওয়া যায় AI Premium Shop-এ — ChatGPT Plus (BDT ৩৫০), Google AI Pro (BDT ৫০০), Canva Pro (BDT ৪৯৯), Perplexity Pro (BDT ৩৫০)। bKash/Nagad দিয়ে পেমেন্ট — আন্তর্জাতিক কার্ড লাগবে না।
        </p>
      </div>
