...
const tools = [{ name: "Claude Pro", slug: "claude-pro-bangladesh", price: "৳1,495/mo", desc: "200K context window for analyzing entire research papers and long documents at once." },
    { name: "Perplexity Pro", slug: "perplexity-pro-bangladesh", price: "৳599/mo", desc: "AI-powered deep research with real citations. 300+ Pro searches/day." },
...
const faqs = [{ question: "Which AI is best for academic research in Bangladesh?", answer: "Claude Pro (৳1,495/mo) is the best for long-document analysis with 200K context — upload entire theses or books. Perplexity Pro (৳599/mo) provides real citations for literature review. Together they're an unbeatable research stack." }];
