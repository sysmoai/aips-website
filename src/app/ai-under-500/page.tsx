...
export default function AIUnder500Page() {
  return (<>
    ...
    <main className="min-h-screen"><section className="mx-auto max-w-4xl px-5 sm:px-8 py-12">
      ...
      <h1 className="mt-3 text-4xl sm:text-5xl font-bold tracking-tight">AI Tools Under BDT 500/Month — 2026</h1>
      <p className="mt-4 text-lg leading-7 text-[#8a91a8]">21 affordable AI subscriptions for Bangladeshi users. bKash/Nagad payment.</p>
      ...
      <div className="mt-6 p-4 rounded-xl border border-[#f4b942]/10 bg-[#f4b942]/[0.03]">
        ...
        <p className="mt-2 text-[0.875rem] leading-relaxed text-[#c9ceda]">
          You can get <strong>20 premium AI subscriptions under BDT 500/month</strong> at AI Premium Shop — including ChatGPT Plus (BDT 499), Google AI Pro (BDT 499), Canva Pro (BDT 499), and Perplexity Pro (BDT 499). All with bKash/Nagad payment — no international card needed. Trusted by a growing community of customers since 2024.
        </p>
      </div>
      ...
      <div className="mt-6 p-4 rounded-xl border border-white/[0.04] bg-white/[0.02]">
        ...
        <p className="text-[0.875rem] leading-relaxed text-[#8a91a8]">
          <strong>BDT 499/মাসের নিচে 20টি প্রিমিয়াম AI টুল</strong> পাওয়া যায় AI Premium Shop-এ — ChatGPT Plus (BDT ৩৫০), Google AI Pro (BDT ৫০০), Canva Pro (BDT ৪৯৯), Perplexity Pro (BDT ৩৫০)। bKash/Nagad দিয়ে পেমেন্ট — আন্তর্জাতিক কার্ড লাগবে না।
        </p>
      </div>
      ...
      <div className="mt-10 flex justify-center">
        <a href={`https://wa.me/${process.env.NEXT_PUBLIC_WA_PRIMARY ?? "8801865385348"}?text=${encodeURIComponent("Hi, what can I get under BDT 500?")}`} className="btn-whatsapp h-12 px-8 text-[0.875rem]">
